...
<div align="center">
  ...
  <h3><b>Microverse React capstone project - Metrics webapp Module 3</b></h3>
...
- [📖 Microverse React capstone project - Metrics webapp Module 3 ](#-microverse-react-capstone-project---metrics-webapp-module-3-)
...
# 📖 Microverse React capstone project - Metrics webapp Module 3 <a name="about-project"></a>
...
one page for the item details; in the example, the detail page for Czech Republic cities with number of views. Use 'vercel --prod' to deploy the project to production. 
...
```sh
  cd my-folder
  git clone https://github.com/Abdulwhbhussain/Metrics-Webapp-Microverse.git
```
